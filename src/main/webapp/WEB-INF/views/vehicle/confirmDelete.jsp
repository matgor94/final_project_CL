...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3">Usuwanie pojazdu</a>
...
<div class="container" align="center">
    <form method="post" action="">
        <p>Czy usunąć pojazd o <strong>id = ${vehicle.id}?</strong></p>
        <p>
            <input type="hidden" name="id" value="${vehicle.id}"/>
            <a href="/task/all"> <button class=" btn btn-primary"> Nie</button> </a>
