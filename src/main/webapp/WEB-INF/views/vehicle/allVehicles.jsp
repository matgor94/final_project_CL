...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3">Warsztat motoryzacyjny - Lista pojazdów</a>
                ...
                <table class="table table-striped table-sm">
                    ...
                    <c:forEach items="${vehiclesList}" var="vehicle">
                        <tr>
                            ...
                            <td>${vehicle.capacity}</td>
                            <td>
                                <a href="/vehicle/edit?id=${vehicle.id}" class="btn btn-dark" role="button">Edytuj</a>
                                <a href="/vehicle/delete?id=${vehicle.id}" class="btn btn-danger" role="button">Usuń</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
                <a href="/vehicle/add" class="btn btn-primary" role="button">Dodaj pojazd </a>
            </div>
        </main>
    </div>
</div>
