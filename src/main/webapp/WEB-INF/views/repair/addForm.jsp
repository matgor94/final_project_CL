...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3">Formularz dodawania naprawy</a>
...
<div class="container" align="center" >
    ...
    <form:form method="post" modelAttribute="repair" >
        ...
        <div class="mb-3">
            ...
            <form:select path="task" items="${tasks}" placeholder="Zlecenie" class="form-control"/>
        </div>
