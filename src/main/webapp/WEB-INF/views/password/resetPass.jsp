...
<div class="px-4 py-5 my-5 text-center">
    ...
    <div class="col-lg-6 mx-auto">
        <p class="lead mb-4">Czy na pewno chcesz zresetować swoje dotychczasowe hasło?</p>
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
            <a href="/reset_password/rand" type="button" class="btn btn-primary btn-lg px-4 gap-3">Tak</a>
            <a href="/logout" type="button" class="btn btn-outline-secondary btn-lg px-4">Nie</a>
        </div>
    </div>
</div>
