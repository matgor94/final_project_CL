...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3">Rejestracja użytkownika</a>
    ...
    <form:form method="post" modelAttribute="user">
     <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <form:input type="password" path="password" placeholder="Hasło" id="pass" class="form-control"/>
            <div align="start">
