...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3">Usuwanie użytkownika</a>
...
<div class="container" align="center">
    <form method="post" action="">
        <p>Czy usunąć użytkownika o <strong>id = ${user.id}?</strong></p>
        <p>
            <input type="hidden" name="id" value="${user.id}"/>
            <a href="/user/all"> <button class="btn-primary"> Nie</button> </a>
            <button type="submit" class="btn-danger">Tak</button>
        </p>
    </form>
</div>
