...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3">Warsztat motoryzacyjny - Lista użytkowników</a>
                ...
                <table class="table table-striped table-sm">
                    ...
                    <c:forEach items="${userList}" var="user">
                        <tr>
                            ...
                            <td>${user.email}</td>
                            <td>
                                <a href="/user/edit?id=${user.id}" class="btn btn-dark" role="button">Edytuj</a>
                                <a href="/user/delete?id=${user.id}" class="btn btn-danger" role="button">Usuń</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
                <a href="/user/addUser" class="btn btn-primary" role="button">Dodaj użytkownika </a>
            </div>
        </main>
    </div>
</div>
